...
class IOSInAppBrowser extends PlatformInAppBrowser with ChannelController {
  @override
  ...
  @override
  IOSInAppWebViewController? get webViewController {
...
extension InternalInAppBrowser on IOSInAppBrowser {
