...
const String _pluginChannelPrefix = 'wtf.zikzak/zikzak_inappwebview';
...
class CustomPlatformViewController
  ...
  Future<void> initialize({
    ...
    _textureId =
        (await _pluginChannel.invokeMethod<int>(
          'createInAppWebView',
          arguments,
        ))!;

    _methodChannel = MethodChannel(
      'wtf.zikzak/custom_platform_view_$_textureId',
    );
    _eventChannel = EventChannel(
      'wtf.zikzak/custom_platform_view_${_textureId}_events',
    );
...
class _CustomPlatformViewState extends State<CustomPlatformView> {
  ...
  Widget build(BuildContext context) {
    return Focus(
      ...
      debugLabel: "zikzak_inappwebview_windows_custom_platform_view",
